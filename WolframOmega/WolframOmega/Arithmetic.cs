...
{
    class Arithmetic : ICalculation
    {
        public string Name => "Арифметические вычисления";

        public string Message => "Считает арифметическое выражение, состоящее из чисел и знаков '+', '-', '/', '*', '(', ')'";
